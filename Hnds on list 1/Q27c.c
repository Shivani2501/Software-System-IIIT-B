...
int main() {
    ...
    if (execle(command, args[0], args[1], args[2], NULL, environ) == -1) {
        perror("execle");
        exit(EXIT_FAILURE);
    }
...
/*
output
shivani-sanjiv-shukla@shivani-sanjiv-shukla-82K2:~$ gcc Q27c.c
...
-rw-rw-r-- 1 shivani-sanjiv-shukla shivani-sanjiv-shukla   596 Aug 31 23:32  Q27c.c
...
-rwxrwxr-x 1 shivani-sanjiv-shukla shivani-sanjiv-shukla 16168 Aug 31 23:32  a.out
...
drwxrwxr-x 2 shivani-sanjiv-shukla shivani-sanjiv-shukla   4096 Aug 31 23:31  MT2024146
