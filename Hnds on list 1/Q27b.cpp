...
int main()
{
	cout<<"Executing 'ls -R1' using execlp...";
	execlp("ls","ls","-R1",nullptr);
	cerr<<"Failed : ";
		return 1;
}
/*
 * output
 * shivani-sanjiv-shukla@shivani-sanjiv-shukla-82K2:~$ g++ Q27b.cpp
...
shivani-sanjiv-shukla@shivani-sanjiv-shukla-82K2:~$ open Q27b.cpp
